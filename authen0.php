...
<?php
			}else die("Désolé, votre mot de passe $passdecode est erroné <a href=$lien>Essayer encore</a>");
		} else die("Désolé, vous n'avez pas été reconnu(e). <a href=$lien>Essayer encore</a>");
}
else die("Désolé, vous devez indiquer un identifiant et un mot de passe. <a href=$lien>Essayer encore</a>");
?>
</body>
</html>
